...
[Get started now](#getting-started){: .btn .btn-purple .fs-5 .mb-4 .mb-md-0 .mr-2}[<img src="./assets/images/github.png" width="15" height="15"> Source code on GitHub](https://github.com/IoBT-VISTEC//MIN2Net){: .btn .fs-5 .mb-4 .mb-md-0 .mr-1} [Documentation](xxx){: .btn .fs-5 .mb-4 .mb-md-0}
